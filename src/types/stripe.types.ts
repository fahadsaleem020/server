...
export type CurrencyCode = (typeof supportedCountries)[CountryName];
export type CountryName = keyof typeof supportedCountries;

interface ResponseBase {
  rates: { [Code in CurrencyCode]: number };
...
interface ReponseSuccess extends ResponseBase {
  result: "success";
}
...
export type ExchangeRateResponse = ReponseSuccess | ResponseError;
